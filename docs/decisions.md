...
| [ADR-023](#adr-023-터미널-플러그인-1호) | 터미널 (플러그인 1호) | 2026-04-25 | 🔴 Superseded by ADR-033 |
...
| [ADR-033](#adr-033-터미널-native-libghostty-runtime) | 터미널 native libghostty runtime | 2026-05-01 | ✅ Accepted |
...
따라서 WebView 안에서 터미널 GPU/canvas 렌더러를 유지하는 접근은 폐기한다.
새 결정은 [ADR-033](#adr-033-터미널-native-libghostty-runtime) 를 따른다.
